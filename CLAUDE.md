...
the four persona `output-styles/*.md`, `skills/{hails-session-start,hails-scratchpad-check,hails-persona,
hails-nsfw-comment-audit,hails-security-audit,hails-fiction-export,hails-fiction-import,
hails-session-end,hails-persona-refresh,hails-decision-register,hails-notice-board}/`, `scripts/pick-persona.js`,
`scripts/session-start-log.js`, and
